...
app.get('/api/word', (req, res) => {
  ...
  const record = sessions.getRecordSerssion();
  const messages = users.wordFor;

  res.json({session,record,messages});
});
